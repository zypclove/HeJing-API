using CommonMormon.STS.Identity.Configuration;
using CommonMormon.STS.Identity.Configuration.ApplicationParts;
using CommonMormon.STS.Identity.Configuration.Constants;
...
namespace CommonMormon.STS.Identity.Helpers
{
