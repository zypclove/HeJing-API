...
using IdentityServer.Admin.BusinessLogic.Identity.Mappers.Configuration;
using IdentityServer.Admin.BusinessLogic.Identity.Resources;
using IdentityServer.Admin.BusinessLogic.Identity.Services;
using IdentityServer.Admin.BusinessLogic.Identity.Services.Interfaces;
using IdentityServer.Admin.EntityFramework.Identity.Repositories;
using IdentityServer.Admin.EntityFramework.Identity.Repositories.Interfaces;
using IdentityServer.Admin.EntityFramework.Interfaces;

namespace IdentityServer.Admin.BusinessLogic.Identity.Extensions
{
