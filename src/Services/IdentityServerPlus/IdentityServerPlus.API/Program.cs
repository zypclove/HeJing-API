...
services.AddDbContext<IdentityServerPlusDbContext>(options =>
{
    options.EnableSensitiveDataLogging(true);
    options.UseSqlServer(configuration.GetConnectionString("IdentityServerPlusDbConnection")!, b => b.MigrationsAssembly("IdentityServerPlus.API"));
});
