...
using IdentityServer.Admin.UI.Configuration.ApplicationParts;
using IdentityServer.Admin.UI.Configuration.Constants;
using IdentityServer.Admin.UI.ExceptionHandling;
using IdentityServer.Admin.UI.Helpers.Localization;
using IdentityServer.Admin.UI.Middlewares;
using IdentityServer.Shared.Configuration.Authentication;

namespace IdentityServer.Admin.UI.Helpers
{
