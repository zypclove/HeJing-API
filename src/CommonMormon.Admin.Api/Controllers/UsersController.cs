...
namespace CommonMormon.Admin.Api.Controllers
{
        ...
        where TRoleClaimDto : RoleClaimDto<TKey>
    {
        ...
        [HttpPost("Roles")]
        public async Task<IActionResult> PostUserRoles([FromBody] MenuOutDto<TKey> role)
        {
        ...
        [HttpDelete("Roles")]
        public async Task<IActionResult> DeleteUserRoles([FromBody] MenuOutDto<TKey> role)
        {
            var userRolesDto = _mapper.Map<TUserRolesDto>(role);
